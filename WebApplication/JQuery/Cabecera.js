$(document).ready(function () {
    ...
    var _descripcion, _valorv, _valori, _fila, _fil, _data, _id, _parametro, _output, _checked;
    ...
    $('#btnAgregar').click(function () {
        if ($.trim($('#txtDetalle').val()).length == 0) {
            ...
            alertify.notify('ingrese detalle..!', 'warning', 5, function () { console.log('dismissed'); });
        ...
        if ($.trim($('#txtValorV').val()).length == 0 && $.trim($('#txtValorI').val()).length == 0) {
            ...
            alertify.notify('valor de texto o entero..?', 'warning', 5, function () { console.log('dismissed'); });
        ...
        if ($.trim($('#txtValorV').val()).length > 0 && $.trim($('#txtValorI').val()).length > 0) {
            ...
            alertify.notify('solo valor de texto o entero..!', 'error', 5, function () { console.log('dismissed'); });
            return;
        }
        ...
        if (_tipoSave == 'add') {
            $.each(_result, function (i, item) {
                if (item.ArryPadeNombre.toUpperCase() == _descripcion.toUpperCase()) {
                    ...
                    alertify.notify('nombre del parametro ya existe..!', 'error', 5, function () { console.log('dismissed'); });
                    _continuar = false;
                    return false;
                } else {
                    $.each(_result, function (i, item) {
                        if (_valori == 0) {
                            if (item.ArryPadeValorV.toUpperCase() == _valorv.toUpperCase()) {
                                ...
                                alertify.notify('valor texto parametro ya existe..!', 'error', 5, function () { console.log('dismissed'); });
                                _continuar = false;
                                return false;
                            } else {
                                _continuar = true;
                            ...
                            if (item.ArryPadeValorI == _valori) {
                                ...
                                alertify.notify('valor entero parametro ya existe..!', 'error', 5, function () { console.log('dismissed'); });
                                _continuar = false;
                                return false;
                            } else {
                                _continuar = true;
                    ...
                    if (_valoriold != _valori) {
                        $.each(_result, function (i, _item) {
                            if (_item.ArryPadeValorI == _valori) {
                                ...
                                alertify.notify('valor entero del parametro ya existe..!', 'error', 5, function () { console.log('dismissed'); });
                                _seguir = false;
                                return false;
                            } else {
                                _seguir = true;
                    ...
                    if (_valorvold.toUpperCase() != _valorv.toUpperCase()) {
                        $.each(_result, function (i, _item) {
                            if (_item.ArryPadeValorV.toUpperCase() == _valorv.toUpperCase()) {
                                ...
                                alertify.notify('valor texto del parametro ya existe..!', 'error', 5, function () { console.log('dismissed'); });
                                _seguir = false;
                                return false;
                            } else {
                                _seguir = true;
    ...
    $("#btnGuardarPa").click(function (eve) {
        ...
        if (_nomparametro == '') {
            ...
            nalertify.notify('ingrese nombre del parametro..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }
        ...
        $.ajax({
            ...
            success: function (datos) {
                if (datos.success == true) {
                    ...
                    alertify.notify('paramentro ya existe..!', 'error', 5, function () { console.log('dismissed'); });
                }
            },
                ...
                success: function (data) {
                    if (data.success == true) {
                        ...
                        alertify.success('paramentro eliminado')
                         ...
                         alertify.notify('hay detalles asociados..!', 'error ', 5, function () {
