...
$(document).ready(function () {
    ...
    var _fila, _data, _row, _estado, _userId, _perfi;

    $("#btnNuevo").click(function (eve) {
        eve.preventDefault();
       
        var modal = $("#myModal #modal-content"); 
        $(modal).load(modal.data('url')); 
    ...
    $("#btnGuardar").click(function (eve) {
        ...
        if (_perfil == "") {
            ...
            alertify.notify('seleccione el perfil..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_nombres == "") {

            alertify.notify('ingrese nombre..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }
        if (_apellidos == "") {
            alertify.notify('ingrese apellido..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }
        if (_login == "") {
            alertify.notify('ingrese un usuario..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }
        if (_password == "") {
            alertify.notify('ingrese una contraseña..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }
    ...
    $(document).on("click", "#btnEditar", function (eve) {
        ...
        var modal = $("#myModalEdit #modal-content"); 
        $(modal).load(modal.data('url') +"/"+ _loginAnt); 
