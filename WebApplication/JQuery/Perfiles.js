$(document).ready(function () {
    ...
    var _fila, _row, _datSet, _button, _estado, _PerfilId, _perfi;
    ...
    $("#btnGuardar").click(function (eve) {
        ...
        if (_perfilNombre == "") {
            ...
            alertify.notify('ingrese un perfil..!', 'warning ', 5, function () { console.log('dismissed'); });
            return;
        }
        ...
        $.ajax({
            ...
            success: function (datos) {
                ...
                if (datos.success == true) {
                    ...
                    alertify.notify('perfil ya existe..!', 'error ', 5, function () { console.log('dismissed'); });
                }
            }
        });
