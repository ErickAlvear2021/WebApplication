$(document).ready(function () {
    ...
    $("#BtnLogin").click(function (eve) {
        ...
        if (_usuario == "") {
            ...
            alertify.notify('ingrese usuario..!', 'warning ', 5, function () { console.log('dismissed'); });
            return;
        }
        ...
        $.ajax({
            ...
            success: function (datos) {
                if (datos.success) {
                    ...
                    alertify.notify('usuario y/o contraseña incorrecto', 'danger ', 5, function () { console.log('dismissed'); });
                    $("#txtUsuario").val('');
                    $("#txtPassword").val('');
