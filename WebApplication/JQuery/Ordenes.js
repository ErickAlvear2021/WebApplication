$(document).ready(function () {
    ...
    var _fecha_inicio, _fecha_fin, _fechaactual, _horainicio;
    var fecha = new Date();
    ...
    $('#btnGuardar').click(function () {
        ...
        if (_clienteid == '') {
            ...
            alertify.notify('seleccione cliente..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_equipoid == '0') {
            alertify.notify('seleccione equipo..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_tipotrabajo == '') {
            alertify.notify('seleccione trabajo..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_tecnico == '') {
            alertify.notify('seleccione tecnico..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_descripcion == '') {
            alertify.notify('ingrese descripcion..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_fechainicio == '') {
            alertify.notify('ingrese fecha inicio..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_horainicio == '') {
            alertify.notify('ingrese hora inicio..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }

        if (_horafin == '') {
            alertify.notify('ingrese hora fin..!', 'warning', 5, function () { console.log('dismissed'); });
            return;
        }
        ...
        if (_fechainiot < _fechaactual) {
            ...
            alertify.notify('La Fecha de Inicio no Puede ser Menor a la Actual..!', 'danger', 5, function () { console.log('dismissed'); });
            return;
        }
        ...
        if (_fechafinot < _fechainiot) {
            ...
            alertify.notify('La Fecha Fin no Puede ser Menor a la Fecha Inicio..!', 'danger', 5, function () { console.log('dismissed'); });
            return;
        }
        ...
        $.ajax({
            ...
            success: function (datos) {
                if (datos.success == true) {
                    ...
                    alertify.notify('ya existe..!', 'error', 5, function () { console.log('dismissed'); });
                    return;
                }
            },
